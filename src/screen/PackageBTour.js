...
export default class PackegeBTourScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      data: '',
  ...
  componentDidMount() {
    return fetch(
      'http://172.16.156.151/mobile_app/final_test/API/get_customer_BTour.php',
    )
      ...
      <View
        ...
        <Card>
          <View style={{margin: 10}}>
            <Card.Title style={{fontSize: 25}}>Boat Tour</Card.Title>
          </View>
          <View style={{flex: 1}}>
            <FlatList
